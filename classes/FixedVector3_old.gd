# @tool
# # extends Resource
# # class_name FixedVector3GDConstant

# var fixedVector3: Resource = preload("res://classes/FixedVector3.cs")
...
# # static var UP: FixedVector3 = fixedVector3.new(0, FixedIntGDConstant.FIXED_ONE, 0)
